      ...
      <div className="container px-4 md:px-6">
        ...
        <div className="grid lg:grid-cols-5 gap-8 items-center max-w-6xl mx-auto py-12">
            <div className="lg:col-span-2 space-y-4">
                <h3 className="text-2xl font-bold">Você não está comprando um panetone.</h3>
                ...
                <p className="text-sm text-muted-foreground pt-4">Enquanto um panetone gourmet custa R$ 80 a R$ 150, aqui você aprende a fazer panetones ilimitados por uma fração do preço.</p>
            </div>
            <div className="lg:col-span-3">
                 <Card className="shadow-2xl border-2 border-accent transform scale-105">
                    <CardHeader className="text-center bg-primary/5 rounded-t-lg">
                        <CardTitle className="text-2xl font-headline">Acesso Completo ao APP</CardTitle>
