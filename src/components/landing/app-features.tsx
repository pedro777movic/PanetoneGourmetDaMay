      ...
      <div className="container px-4 md:px-6">
        <div className="flex flex-col items-center justify-center space-y-4 text-center">
          <div className="space-y-2">
            <h2 className="text-3xl font-headline font-bold tracking-tighter sm:text-5xl text-primary">O que você encontra no APP</h2>
            <p className="max-w-[900px] text-muted-foreground md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
              Tudo que você precisa para dominar a arte do panetone gourmet, do zero ao profissional.
            </p>
          </div>
        </div>
        <div className="mx-auto grid max-w-4xl gap-8 py-12 sm:grid-cols-2 lg:grid-cols-3 lg:gap-12">
