  ...
  return (
    <section id="final-cta" className="w-full py-12 md:py-24 lg:py-32 bg-primary text-primary-foreground">
      <div className="container px-4 md:px-6 text-center space-y-6">
        <h2 className="text-3xl font-headline font-bold tracking-tighter sm:text-4xl md:text-5xl text-center">
          🎄 Se Você Deixar Para Depois… Vai Ficar de Fora.
        </h2>
        <p className="max-w-xl mx-auto text-base md:text-lg text-primary-foreground/80 text-center">
